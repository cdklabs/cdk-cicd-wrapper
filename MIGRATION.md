...
`RES`/`DEV`/`INT`. If you defined lowercase or custom-case stages in Blueprint (`staging`, `gamma`, `Prod`),
**drop `uppercaseStage`** (the stage is used as-is) or set `stackName` to your literal Blueprint name — otherwise
