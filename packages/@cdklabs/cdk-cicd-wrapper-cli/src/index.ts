...
import check from './cmds/zerotouch/CheckCommand';
import deployCi from './cmds/zerotouch/DeployCiCommand';
import deploy from './cmds/zerotouch/DeployCommand';
import deploymentApp from './cmds/zerotouch/DeploymentAppCommand';
import exec from './cmds/zerotouch/ExecCommand';
import migrate from './cmds/zerotouch/MigrateCommand';
import pipelineApp from './cmds/zerotouch/PipelineAppCommand';
import synth from './cmds/zerotouch/SynthCommand';
