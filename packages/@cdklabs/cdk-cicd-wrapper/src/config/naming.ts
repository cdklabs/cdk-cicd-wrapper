...
//
// Stack-name control for Autopilot apps. Autopilot synthesizes the SAME `bin/` once per stage (deploy-time), so a bare
 ...
 *
 * New Autopilot projects: `stageStackName('myapp')` -> `myapp-dev` / `myapp-prod`.
 *
