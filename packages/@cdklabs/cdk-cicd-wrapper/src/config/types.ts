...
export interface ResolvedCicdConfig {
  ...
  /**
   * Export per-stage account env vars on a self-mutating engine's synth step: before `cdk synth`, scan
   ...
   * accounts at synth time from the values the bootstrap wrote to SSM.
