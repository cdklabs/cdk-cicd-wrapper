...
// injection hook (opt-in only, matching Blueprint -- retaining KMS keys by default is the safer stance).
...
/**
 * Applies `RemovalPolicy.DESTROY` to every L2 KMS `Key` it visits, matching Blueprint's
