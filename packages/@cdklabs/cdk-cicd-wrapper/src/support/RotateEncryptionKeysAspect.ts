...
//
// v2 shipped this as `RotateEncryptionKeysPlugin`, on by default (m9-migrate-security-plugins). v3
...
/**
 * Enables key rotation on every KMS key it visits, matching v2's default-on
