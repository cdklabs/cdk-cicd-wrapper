...
import { AppConfig } from '../../../src/v3/appconfig';
import * as inject from '../../../src/v3/runtime/inject';
import { appsConstructed, assertAppModuleLayout } from '../../../src/v3/runtime/inject';
// Side-effecting import: patches App. Must come after the other imports so the assertions
// below observe the patched module.
import '../../../src/v3/runtime/register';
