...
// stack name per stage (and, on a migration, to reproduce a v2 name so resources are updated in place, not
...
new MyStack(app, 'cdk-v3-example', {
  // -> `cdk-v3-example-dev` / `cdk-v3-example-prod`. Migrating from v2? Use
